    ...
    <header>
            ...
            <div class="container mt-4">
                ...
                <div class="d-flex bd-highlight mb-1">
                    ...
                    <div class="ml-auto pr-2 bd-highlight">
                        <form class="form-inline my-2 my-lg-0" method="POST" action="cliente.php">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php
                    $query_total = "SELECT COUNT(id_usuario) as clientes FROM usuario WHERE id_tipo=2";
                    ...
                    <a class="page-link" href="cliente.php?page=' . urlencode($previous_page) . '">Anterior</a>
                        </li>';
                    $result_total = $mysqli->query($query_total);

                    $total_results = $result_total->fetch_assoc();

                    $total_results = (int) $total_results["clientes"];
                    ...
                    for ($i = 1; $i <=$pages; $i++){
                        echo '<li class="page-item">
                                <a class="page-link" href="cliente.php?page=' . urlencode($i) . '">' . htmlspecialchars($i). '</a>
                                </li>';
                    }
                    if (isset($_GET['page'])){
                    ...
                    echo '<li class="page-item">
                        <a class="page-link" href="cliente.php?page=' . urlencode($next_page) . '">Siguiente</a>
                    </li>';
