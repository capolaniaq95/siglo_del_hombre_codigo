    ...
    <header>
            ...
            <div class="container mt-4">
                ...
                <div class="d-flex bd-highlight mb-1">
                    ...
                    <div class="ml-auto pr-2 bd-highlight">
                        <form class="form-inline my-2 my-lg-0" method="POST" action="aceptada.php">
                ...
                <div>
                    ...
                    if (isset($_GET['page'])){
                        ...
                        WHERE $by LIKE '%$search%'
                            AND devolucion.estado ='Aceptada'
                        ORDER BY devolucion.id_devolucion
                        DESC
                        LIMIT 10";
                    }else{
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php
                    $query_total = "SELECT COUNT(id_devolucion) as devoluciones FROM devolucion WHERE devolucion.estado='Aceptada'";
                    ...
                    <a class="page-link" href="aceptada.php?page=' . urlencode($previous_page) . '">Anterior</a>
                        </li>';
                    ...
                    for ($i = 1; $i <=$pages; $i++){
                        echo '<li class="page-item">
                                <a class="page-link" href="aceptada.php?page=' . urlencode($i) . '">' . htmlspecialchars($i). '</a>
                                </li>';
                    }
                    if (isset($_GET['page'])){
                    ...
                    echo '<li class="page-item">
                        <a class="page-link" href="aceptada.php?page=' . urlencode($next_page) . '">Siguiente</a>
                    </li>';
