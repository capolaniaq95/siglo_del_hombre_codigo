    ...
    <header>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php
                    $query_total = "SELECT COUNT(id_devolucion) as devoluciones FROM devolucion WHERE devolucion.estado='Proceso'";
