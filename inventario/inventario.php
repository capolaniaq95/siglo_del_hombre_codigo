    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php
                    $query_total = "SELECT COUNT(id_movimiento) as movimientos FROM movimiento_inventario";
                    ...
                    <a class="page-link" href="inventario.php?page=' . urlencode($previous_page) . '">Anterior</a>
                        </li>';
                    $result_total = $mysqli->query($query_total);

                    $total_results = $result_total->fetch_assoc();

                    $total_results = (int) $total_results["movimientos"];
                    ...
                    for ($i = 1; $i <=$pages; $i++){
                        echo '<li class="page-item">
                                <a class="page-link" href="inventario.php?page=' . urlencode($i) . '">' . htmlspecialchars($i). '</a>
                                </li>';
                    }
                    if (isset($_GET['page'])){
                    ...
                    echo '<li class="page-item">
                        <a class="page-link" href="inventario.php?page=' . urlencode($next_page) . '">Siguiente</a>
                    </li>';
