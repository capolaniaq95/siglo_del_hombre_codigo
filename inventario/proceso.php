    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <main class="flex-fill">
            <div class="container mt-4">
                <h2>Movimientos inventario en Proceso</h2>
                ...
                if (isset($_GET['page'])){
                    ...
                    WHERE
                        movimiento_inventario.estado = 'Proceso'
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo '<tr>
                                        ...
                                        <td>
                                            <a href="consultar.movimiento.php?id_movimiento=' . urlencode($row["id_movimiento"]) . '" class="btn btn-info btn-sm">Consultar</a>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php
                    $query_total = "SELECT COUNT(id_movimiento) as procesos FROM movimiento_inventario
                                    WHERE movimiento_inventario.estado = 'Proceso'";
                    ...
                    <a class="page-link" href="proceso.php?page=' . urlencode($previous_page) . '">Anterior</a>
                        </li>';
                    $result_total = $mysqli->query($query_total);

                    $total_results = $result_total->fetch_assoc();

                    $total_results = (int) $total_results["procesos"];
                    ...
                    for ($i = 1; $i <=$pages; $i++){
                        echo '<li class="page-item">
                                <a class="page-link" href="proceso.php?page=' . urlencode($i) . '">' . htmlspecialchars($i). '</a>
                              </li>';
                    }
                    if (isset($_GET['page'])){
