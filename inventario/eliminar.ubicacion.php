        ...
        <div class="container mt-4">
            ...
            if (isset($_GET['id'])) {
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if ($mysqli->query($sql) === TRUE) {
                        echo "<div class='alert alert-info'>ubicacion eliminado correctamente.</div>";
                        echo "<a href='ubicacion.php' class='btn btn-primary'>Volver a la lista de ubicaciones</a>";
                    } else {
                        echo "<div class='alert alert-danger'>Error al eliminar el ubicacion: " . $mysqli->error . "</div>";
                    }
                    $mysqli->close();
                    exit;
                } else {
                    $sql = "SELECT ubicacion FROM ubicacion WHERE id_ubicacion = '$id_ubicacion'";
            ...
            <form action="" method="post">
                <div class="alert alert-warning">
                    <strong>Advertencia:</strong> ¿Estás seguro de que deseas eliminar la ubicacion? "<?php echo $ubicacion['ubicacion']; ?>"? Esta acción no se puede deshacer.
                </div>
                <button type="submit" class="btn btn-info">Eliminar ubicacion</button>
